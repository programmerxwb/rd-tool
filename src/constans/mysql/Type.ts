...
export function isDate(type:number) : boolean {
  let dataType:number[] = [MysqlTypeEnum.DATE, MysqlTypeEnum.DATETIME, MysqlTypeEnum.NEWDATE, MysqlTypeEnum.TIME, MysqlTypeEnum.TIMESTAMP]
